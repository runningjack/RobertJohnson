...
class Ticketreply{
    ...
    protected static $table_name="support_reply";

	protected static $db_fields=array("id","ticket_id","sender_id","sender_name","sender_type","message","datecreated");
    ...
    public static function find_by_ticket($id){

		global $database;

		$result_set =self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE ticket_id = $id ORDER BY datecreated DESC");
