...
class Sign_off{
	...
	protected static $db_fields=array('id','prod_id','mag_strip','verve_card','master_card','visa_card','withdraw','witdraw_comment','balance','balance_comment','statement','statement_comment','transfer','transfer_comment','pin_change','pin_change_comment','mobile_recharge','mobile_recharge_comment','part_replace','camera_instal','inverter_status','AC_status','ATM_room_cond','cse_remark','client_remark','employee_id','scan_url');
	public $id;
    public $prod_id;
	public $mag_strip;
	public $verve_card;
