...
class Employee{
	...
	protected static $db_fields=array('id','emp_id','emp_lname','emp_mname','emp_fname','emp_sex','emp_mstatus','emp_religion','emp_dob','emp_nationality','emp_soo',
    'emp_lga','emp_email','emp_phone','emp_address','emp_date_employed',
    'emp_date_terminate','emp_dept','emp_post','emp_type','emp_uname','emp_pword','emp_qualification','datecreated','datemodified','img_url','emp_status');
	public $id;
	public $emp_id;
	public $emp_lname;
	public $emp_mname;
