...
class Ccemail{
    ...
    protected static $table_name="ccemail";

	protected static $db_fields=array("id","email","ticket_id");
    ...
    public static function find_by_ticket($id){
		...
		$result_set =self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE ticket_id = $id");
