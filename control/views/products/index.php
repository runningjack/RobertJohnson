<div class="panel callout">
	<h4 style="display:inline">Product Listing</h4><a href="<?php 
    global $session; 
    ...
    }elseif(($session->rolename=="Customer Support Service" || $session->rolename=="Customer Support Services") && in_array("support", $session->privil)){
    ...
    ?>"><span class="btn  right  btn-primary button" style="display:inline"> &laquo;Back To Dashboard</span></a><a href="?url=products/create" ><span class="btn  right  btn-danger button" style="display:inline">Add New</span></a>
</div>
