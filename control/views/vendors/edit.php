...
<div class="panel callout">
	<h4 style="display:inline">Maintain Vendor</h4><a href="<?php echo $uri->link("support/index") ?>"><span class="button secondary right" style="display:inline"> &laquo;Back to Dashboard</span></a>
  ...
  <div class="row">
    ...
    <input type="text" placeholder="Enter Vendor ID" class="six" required="required"   name="vendid" id="vendid" value="<?php echo $this->myvendor->vend_id ?>" />
    </div>
  </div>
