...
<div class="panel callout">
	<h4 style="display:inline">New Vendor</h4><a href="<?php echo $uri->link("support/index") ?>"><span class="button secondary right" style="display:inline"> &laquo;Back to Dashboard</span></a>
