<div class="panel callout">
	<h4 style="display:inline">Worksheet</h4>
    <a href="<?php echo $uri->link("support/worksheetlist") ?>"><span class="button secondary button right" style="display:inline"> &laquo;Back To Listing</span></a>
    <a href="<?php 
        global $session; 
