<div class="panel callout">
	<h4 style="display:inline">Ticket Listing</h4><a href="<?php 
    global $session; 
...
<div class="row filterbox" >
    ...
    <div id="mySearchContainer2" style=" position: absolute; ">
        ...
        <hr />
            <a href="#" id="tkallrec" class="" style="color: #000;">View All Records</a>
        </div>
        <div class="large-3 columns right">
            <a href="#" id="tkfilter" class="btn btn-danger button">Filter Record</a>
        </div>
    </div>
