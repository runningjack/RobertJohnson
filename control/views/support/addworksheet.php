...
<form id="frmpri" name="frmpri" method="post" action="<?php echo $uri->link("support/doCreateWorkSheet") ?>" >
  <fieldset><div id="transalert"></div>
    ...
    <div class="row">
      ...
      <input type="hidden" id="prod_id" name="prod_id" value="<?php echo $cproduct->id ?>" />
    ...
    <div class="row">
      <div class="large-12 columns">
        ...
        <select id="wstatus" name="wstatus">
            ...
            <option value="Closed">Work Sheet Closed</option>
            <option value="Pending">Uncompleted Task Pending</option>
        </select>
      </div>
    </div>
