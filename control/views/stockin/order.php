<div class="panel callout">
	<h4 style="display:inline">New Vendor</h4><a href="<?php 
    global $session; 
    ...
    <a href="<?php echo $uri->link("stockin/ordelisting") ?>"><span class="button secondary right" style="display:inline"> &laquo;Back To Listing</span></a>
</div>
  ...
  <div class="row">
    ...
    <input type="text" placeholder="Enter Vendor ID" class="six"   name="vendid" id="vendid" />
    </div>
  </div>
