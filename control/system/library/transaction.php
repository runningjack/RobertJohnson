<?php
class Transaction{
	protected static $table_name="transactions_log";
	protected static $db_fields=array('id','com_id','user_id','trans_type','trans_description','trans_amount','datecreated','datemodified','status');
	public $id;
    public $com_id;
	public $user_id;
	public $trans_type;
    ...
    public static function find_by_main_id($mainid){
        global $database;
        $result_array =self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE com_id='".$mainid."'");
