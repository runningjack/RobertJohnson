...
class User {
	...
	protected static $db_fields=array('user_id','staff_id','fname','lname','address','city','state','country','phone','img_url','email','username','password','web_url','user_role','date_added','date_modified');
	public $user_id;
	public $staff_id;
	public $fname;
	public $lname;
