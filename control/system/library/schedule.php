...
class Schedule{
	...
	protected static $db_fields=array('id','main_id','emp_id','emp_name','client_id','prod_id','prod_name','s_date','s_time_in','s_time_out','issue','datecreated','datemodified','maint_type','status');
	public $id;
    public $main_id;
    public $emp_id;
	public $emp_name;
	...
	public function create(){
		...
		if ($database->db_query($sql)){
            ...
            $this->main_id  =  self::getID("TASK",$this->id) ;
            $this->update();
			return true;
		}
		else{
