...
class Modules{
	...
	protected static $db_fields=array('id','accronym','css_class','module','link','description','datecreated','datemodified','status');
	public $id;
	public $accronym;
	public $module;
    public $link;
    ...
    public static function find_by_module($module){
		global $database;
		$result_array =self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE module='".$module."'");
		return !empty($result_array) ? array_shift($result_array) : false;
	}
